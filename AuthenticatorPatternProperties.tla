----------------------------- MODULE AuthenticatorPatternProperties -----------------------------
...
TypeOk == /\ user1["id"] = id1 \* P1: user.id = id1 (initial)
          ...
          /\ user1["authInfo"] = authInfoini1  \* P4: user1.authInfo = user2.authInfoini1
          /\ user2["authInfo"] = authInfoini2  
          /\ authenticator["id"] = idini \* P5: authenticator.id = id initial
          /\ user1["authenticator"] = authenticator["id"] \* or idini  P6 : user1.authenticator = a.authenticatorini
          ...
          \*/\ user1["idProof"] # 0 /\ user2["idProof"] # 0 /\ user1["idProof"] # user2["idProof"] \* P9: user1.idProof # user2.idProof (if user1/2.idProof #0)
...
next ==  \*/\ authenticator' = [id |-> idini, authInfo |-> user1["authInfo"]]  \* authenticator recoit un request de user1 -> il recoit la valeur de authInfo: verifier P7
         ...
         \* /\ authenticator' = [id |-> 3, authInfo |-> authInfo]  \*verifier P5 et P6
         /\ UNCHANGED <<user1, authenticator,user2>>


=============================================================================
\* Modification History
\* Last modified Fri Feb 11 13:49:05 CET 2022 by Lara
